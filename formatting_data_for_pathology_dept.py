...
def format_data(pathToData):
	f=open('UC-prospective-patients-nonSyn-stopStart-codon-changes-spliceSites-SIFT-and-or-PROVEAN-deleterious-CADD.txt', 'w')
...
if __name__=='__main__':
	pathToData='/home/tonya/pan_can_project/panData_UCprospective_DNA_mutations/match-SIFT-CADD-UCprospective'
